...
await queryRunner.release();
  ...
  async findAll(user: UserEntity, type: string, page: string, limit: string) {
    ...
    bc.is_multiple_ticket as booking_contract_is_multiple_ticket,cast(b.start_time as TEXT) as start_time,cast(b.end_time as TEXT) as end_time,b.requested_user_id as
   ...
   select e.id as event_id ,f.id as feedback_id, bc.id as booking_contract_id,bc.music_genre as booking_contract_music_genre,bc.start_time as booking_contract_start_time,
    ...
    as booking_contract_ticket_end_date2,bc.ticket_end_date3
    as booking_contract_ticket_end_date3,
    bc.contract_details as booking_contract_details,bc.contract_discription as booking_contract_discription,bc.ticket_sale_agreement as booking_contract_ticket_sale_agreement,bc.is_multiple_ticket as booking_contract_is_multiple_ticket, cast(b.start_time as TEXT) as start_time,cast(b.end_time as TEXT) as end_time,
