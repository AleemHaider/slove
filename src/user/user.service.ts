...
export class UserService {
  ...
  async getConsumerRecommendations(
    ...
    this.logger.log(whereQuery+'order by e.start_time asc '+queryLimit);
    ...
    artist_uq.band_name as artist_name,bc.is_ticket_close,artist_country.name as artist_country,artist_city.name as artist_city,artist.bio as artist_bio,
    ...
    venue_uq.city_id=venue_city.id where e.status='ACTIVE' ${whereQuery}order by event_created_at desc ${queryLimit}`);
